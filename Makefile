...
code/public/utils/core_plugins_utils.o: code/public/utils/core_plugins_utils.c
	$(CC) $(_CFLAGS) -c -o $@ $<

code/public/utils/osd_plugins_utils.o: code/public/utils/osd_plugins_utils.c
	$(CC) $(_CFLAGS) -c -o $@ $<
